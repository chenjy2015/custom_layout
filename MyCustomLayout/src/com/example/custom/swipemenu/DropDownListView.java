...
/**
 * 
 * 类名称：DropDownListView 类描述：实现下拉刷新  创建人：chenjiayou
 * 创建时间：2015-6-25 pm 17:32
 * @version
 * 
 */
...
public class DropDownListView extends ListView implements OnScrollListener {
	...
	private void initDropDownStyle() {
		...
		headerDefaultText = context
				.getString(R.string.drop_down_list_header_default_text);
		headerPullText = context
				.getString(R.string.drop_down_list_header_pull_text);
		headerReleaseText = context
				.getString(R.string.drop_down_list_header_release_text);
		headerLoadingText = context
				.getString(R.string.drop_down_list_header_loading_text);

		LayoutInflater inflater = (LayoutInflater) context
				.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
		headerLayout = (RelativeLayout) inflater.inflate(
				R.layout.drop_down_list_header, this, false);
	...
	private void getAttrs(Context context, AttributeSet attrs) {
		...
		isDropDownStyle = ta.getBoolean(
				R.styleable.drop_down_list_attr_isDropDownStyle, false);
		isOnBottomStyle = ta.getBoolean(
				R.styleable.drop_down_list_attr_isOnBottomStyle, false);
		isAutoLoadOnBottom = ta.getBoolean(
				R.styleable.drop_down_list_attr_isAutoLoadOnBottom, false);
		ta.recycle();
	}
}
